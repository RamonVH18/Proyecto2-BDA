 ...
 * @author rodri
 */
public class MenuProductos extends VentanaBase{
    private IControl navegacion;
    /**
     * Creates new form MenuProductos
     */
    public MenuProductos(IControl control) {
        super(control, "Menu de Productos");
    ...
    private void initComponents() {
        ...
        btnAdministrarProducto = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);

        btnRegreso.setText("jButton1");

        btnRegistroProducto.setText("jButton1");

        btnAdministrarProducto.setText("jButton2");
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(36, 36, 36)
                        .addComponent(btnAdministrarProducto)))
    ...
    private void botonSalirMouseClicked(java.awt.event.MouseEvent evt) {
        ...
        navegacion.cerrarVentana("Menu de Productos");
    } 

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton btnAdministrarProducto;
    private javax.swing.JButton btnRegistroProducto;
    private javax.swing.JButton btnRegreso;
    // End of variables declaration//GEN-END:variables

    /**
     * Metodo necesario para la generacion del Menu de Productos
     */
    private void generarMenuIngredientes() {
        ...
        configuracionBotonModulo(btnRegistroProducto, "Registro Producto", TipoVentana.REGISTRO_PRODUCTO);
        btnAdministrarProducto = new JButton("Administrar Productos");
        configuracionBotonModulo(btnAdministrarProducto, "Administrar Productos", TipoVentana.ADMINISTRAR_PRODUCTO);
    ...
    private void generarPanelCentral(JPanel panelCentral){
        ...
        gbc.gridy = 0; 
        gbc.gridx = 0;
        panelCentral.add(btnRegistroProducto, gbc);

        gbc.gridx = 1;
        panelCentral.add(btnAdministrarProducto, gbc);
